export declare const FORM_FIELD_RADIO_GROUP_DIRECTION_MAP: {
    readonly HORIZONTAL: "horizontal";
    readonly VERTICAL: "vertical";
};
export type FormFieldRadioGroupRef = HTMLDivElement;
export interface FormFieldRadioGroupProps<T = string> extends Omit<React.HTMLAttributes<FormFieldRadioGroupRef>, "onChange" | "defaultChecked"> {
    /**
...
//# sourceMappingURL=FormFieldRadioGroup.types.d.ts.map