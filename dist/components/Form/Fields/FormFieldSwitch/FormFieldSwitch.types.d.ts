 ...
 */
export interface FormFieldSwitchProps extends Omit<React.InputHTMLAttributes<FormFieldSwitchRef>, "type" | "onChange" | "size"> {
    /**
...
//# sourceMappingURL=FormFieldSwitch.types.d.ts.map