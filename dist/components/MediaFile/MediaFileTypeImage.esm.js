...
import t from "react";
import { getMediaFileTypeColor as s } from "./tools.esm.js";
import { TextColors as f } from "../../utils/design/colors.esm.js";
const p = t.memo(({ fileExtension: o, width: r = 40, ...a }) => {
  var i;
  const d = t.useMemo(
    () => s(o),
    [o]
  ), n = f.dark.primary;
  return /* @__PURE__ */ l("svg", { width: r, height: r * 2, viewBox: "0 0 40 40", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...a, children: [
    /* @__PURE__ */ e(
      "path",
      {
...
p.displayName = "MediaFile.TypeImage";
export {
  p as default
};
