...
export interface TableContainerProps<T> extends Omit<React.TableHTMLAttributes<TableContainerRef>, "children" | "bordered" | "width" | "height"> {
    /**
...
export interface TableColumnData<T> {
     ...
     */
    onSort?: (a: T, b: T, sortOrder: (typeof TABLE_CELL_SORT_ORDER_MAP)[keyof typeof TABLE_CELL_SORT_ORDER_MAP]) => number;
    /**
...
//# sourceMappingURL=TableContainer.types.d.ts.map